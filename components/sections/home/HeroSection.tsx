      ...
      <div className="container-custom relative z-10 pt-14">
            ...
            {TABS.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`flex flex-col items-center justify-center py-3.5 px-6 rounded-2xl transition-all duration-200 min-h-[64px] focus:outline-none border-2 cursor-pointer ${
                    isActive
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-5 items-start">
          ...
          <div className="lg:col-span-3 bg-white rounded-2xl border border-slate-200/50 shadow-sm overflow-hidden flex flex-col md:flex-row min-h-[440px]">
            ...
            {/* Sidebar navigation */}
            <div className="w-full md:w-[220px] flex-shrink-0 bg-slate-50 border-r border-slate-100 flex flex-col p-3 gap-1.5">
              {SUB_TABS.map((subTab) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full min-h-[44px] py-3 px-4 rounded-xl text-left text-sm font-semibold transition-all duration-200 focus:outline-none cursor-pointer flex items-center justify-between ${
                      isSubActive
                        ? 'font-bold'
