...
export function getDetailedSectionContent(examId: string, sectionSlug: string): DetailSectionContent | undefined {
  ...
  switch (sectionSlug) {
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-2">
                    <div className="bg-slate-50 p-4 rounded-xl border border-slate-200">
                      <h5 className="font-bold text-slate-800 text-xs sm:text-sm mb-1">Mandatory Documents</h5>
                      <ul className="text-xs text-slate-600 space-y-1 list-disc list-inside">
    ...
    case 'selection-process': {
      return {
        title: `${exam.shortName} Selection Process 2026`,
            ...
            content: (
              <div className="space-y-4">
                ...
                <HighlightBox type="info" title="Weightage Ratios">
                  {isIbps ? (
                    <p className="text-sm">The final selection list is normalized on a scale of 100, combining the Main Examination (Phase II) and Personal Interview (Phase III) in an <strong>80:20 ratio</strong>.</p>
                  ) : (
