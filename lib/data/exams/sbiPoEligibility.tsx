...
export const sbiPoEligibilityContent: DetailSectionContent = {
  ...
  subsections: [
    ...
    {
      id: 'comparison-ibps',
      title: "SBI PO vs IBPS PO Eligibility — Key Differences",
      content: (
        <div className="space-y-4">
          <p className="text-slate-600 text-sm sm:text-[15px] leading-relaxed">
            Many aspirants prepare for both SBI PO and IBPS PO simultaneously. Here is where the eligibility conditions differ:
          </p>
          <div className="w-full overflow-x-auto border border-slate-200 rounded-xl bg-white shadow-xs my-4">
            <table className="w-full text-left text-sm border-collapse min-w-[600px]">
              <thead>
                <tr className="bg-slate-900 text-white font-bold">
                  <th className="px-4 py-2.5">Eligibility Parameter</th>
              ...
              <tbody className="divide-y divide-slate-100 text-slate-655">
                ...
                <tr className="bg-slate-50/50">
                  <td className="px-4 py-3 font-semibold text-slate-800">Maximum Age (General)</td>
                  <td className="px-4 py-3">30 years</td>
                  <td className="px-4 py-3">30 years</td>
                </tr>
                <tr>
                  <td className="px-4 py-3 font-semibold text-slate-800">Educational Qualification</td>
                  <td className="px-4 py-3">Any graduation</td>
                  <td className="px-4 py-3">Any graduation</td>
                </tr>
                <tr className="bg-slate-50/50">
                  <td className="px-4 py-3 font-semibold text-slate-800">Minimum % Required</td>
                  <td className="px-4 py-3">None</td>
                  <td className="px-4 py-3">None</td>
                </tr>
                <tr>
                  <td className="px-4 py-3 font-semibold text-slate-800">Attempt Limit (General)</td>
                  <td className="px-4 py-3 font-bold text-red-650">4 attempts</td>
                  <td className="px-4 py-3 text-green-650">No limit</td>
                </tr>
                <tr className="bg-slate-50/50">
                  <td className="px-4 py-3 font-semibold text-slate-800">Attempt Limit (OBC)</td>
                  <td className="px-4 py-3 font-bold text-red-650">7 attempts</td>
                  <td className="px-4 py-3 text-green-650">No limit</td>
                </tr>
                <tr>
                  <td className="px-4 py-3 font-semibold text-slate-800">Attempt Limit (SC/ST)</td>
                  <td className="px-4 py-3">No limit</td>
                  <td className="px-4 py-3">No limit</td>
                </tr>
                <tr className="bg-slate-50/50">
                  <td className="px-4 py-3 font-semibold text-slate-800">OBC Creamy Layer</td>
                  <td className="px-4 py-3">Not eligible for OBC benefits</td>
                  <td className="px-4 py-3">Not eligible for OBC benefits</td>
                </tr>
                <tr>
                  <td className="px-4 py-3 font-semibold text-slate-800">CIBIL Check</td>
                  <td className="px-4 py-3">Yes — defaults disqualify</td>
                  <td className="px-4 py-3">Less stringent</td>
                </tr>
                <tr className="bg-slate-50/50">
                  <td className="px-4 py-3 font-semibold text-slate-800">Final Year Students</td>
                  <td className="px-4 py-3">Eligible provisionally</td>
                  <td className="px-4 py-3">Eligible provisionally</td>
                </tr>
              </tbody>
            </table>
          ...
          <p className="text-slate-600 text-sm leading-relaxed">
            The biggest practical difference is the <strong>attempt limit</strong>. IBPS PO gives you as many cycles as you remain within the age bracket. SBI PO caps General and EWS candidates at 4 attempts regardless of age. This makes each SBI PO cycle more consequential for General/EWS candidates.
          </p>
        </div>
      )
    },
