// PATH: app/ibps-po-quiz/page.tsx
...
export const metadata: Metadata = {
  title: 'IBPS PO Quiz 2026: Free Mock Test & Practice Questions',
  description: 'Attempt the IBPS PO quiz 2026 with sectional tests, chapter-wise practice and PYQs. Get instant scores and fix weak areas on PrepBanker.',
  keywords: [
    'IBPS PO quiz 2026',
    'IBPS PO mock test 2026',
    'IBPS PO sectional test',
    'IBPS PO practice quiz',
    'IBPS PO PYQ 2026',
    'bank PO online quiz',
  ],
  alternates: {
    canonical: 'https://prepbanker.com/ibps-po-quiz',
  },
  openGraph: {
    title: 'IBPS PO Quiz 2026: Free Mock Test & Practice Questions',
    description: 'Attempt the IBPS PO quiz 2026 with sectional tests, chapter-wise practice and PYQs. Get instant scores and fix weak areas on PrepBanker.',
    url: 'https://prepbanker.com/ibps-po-quiz',
    type: 'website',
    locale: 'en_IN',
  },
};
...
const schemas = [
  {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is the IBPS PO quiz 2026 on PrepBanker?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "It is a free practice hub on PrepBanker with sectional quizzes, chapter-wise DPPs and full mock tests built on the current IBPS PO 2026 exam pattern, covering Quant, Reasoning, English, General Awareness and Computer Aptitude."
        }
      },
      {
        "@type": "Question",
        "name": "Is the PrepBanker IBPS PO quiz free to attempt?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "SBI PO is generally considered slightly tougher because its reasoning and banking awareness questions are more unpredictable and its cut-offs run higher. IBPS PO has more vacancies but a broader competition pool across 11 banks."
        }
      },
      {
        "@type": "Question",
        "name": "How many questions are there in IBPS PO prelims?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "IBPS PO Prelims 2026 consists of 100 objective questions worth 100 marks across English, Quantitative Aptitude and Reasoning, with a total duration of one hour and separate sectional timing."
        }
      },
      {
        "@type": "Question",
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes. PrepBanker quizzes are updated to match the revised IBPS PO 2026 Mains pattern of 170 objective questions for 200 marks, plus descriptive paper."
        }
      },
      {
        "@type": "Question",
        "name": "How many mock tests should I attempt before the IBPS PO prelims?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Most aspirants attempt 20 to 30 full-length mocks and 40 to 50 sectional quizzes in the six to eight weeks before the exam, alongside daily chapter-wise DPPs for weak topics."
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes. PrepBanker quizzes replicate the official negative marking scheme of 0.25 marks deducted per wrong answer, with no penalty for unattempted questions."
        }
      },
      {
        "@type": "Question",
        "name": "How is IBPS PO 2026 different from previous years?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "IBPS PO 2026 (CRP PO/MT-XVI) increased Mains questions from 145 to 170, added a Personality Test stage before the Interview, and shifted extra weightage toward General/Economy/Banking Awareness and Digital Awareness compared to earlier cycles."
        }
      }
    ]
  },
  {
    "@context": "https://schema.org",
    "@type": "Course",
    "name": "IBPS PO Quiz 2026 Practice Series",
    "description": "A free, exam-pattern-aligned practice series covering IBPS PO 2026 Prelims and Mains, including sectional quizzes, chapter-wise DPPs, full mock tests and previous year question papers.",
    "provider": {
      "@type": "Organization",
      "name": "PrepBanker",
    ...
    "about": ["IBPS PO Exam", "Bank PO Preparation"],
    "hasCourseInstance": {
      "@type": "CourseInstance",
      "courseMode": "online",
      "courseWorkload": "PT1H"
  ...
  },
  {
    "@context": "https://schema.org",
    "@type": "Quiz",
    "name": "IBPS PO Quiz 2026",
    "description": "Free sectional and full-length quiz series for IBPS PO 2026 covering Quantitative Aptitude, Reasoning, English Language, General Awareness and Computer Aptitude.",
    "url": "https://prepbanker.com/ibps-po-quiz",
    "about": {
      "@type": "Thing",
      "name": "IBPS PO Recruitment Exam Preparation"
    },
    "educationalAlignment": {
      "@type": "AlignmentObject",
      "alignmentType": "assesses",
      "targetName": "IBPS PO Prelims and Mains Syllabus"
    },
    "provider": {
      "@type": "Organization",
      "name": "PrepBanker",
  ...
  },
  {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "position": 3,
        "name": "IBPS PO Quiz 2026",
        "item": "https://prepbanker.com/ibps-po-quiz"
      }
    ]
  },
  {
    "@context": "https://schema.org",
    "@type": "WebPage",
    "name": "IBPS PO Quiz 2026: Free Mock Test & Practice Questions",
    "description": "Attempt the IBPS PO quiz 2026 with sectional tests, chapter-wise practice and PYQs. Get instant scores and fix weak areas on PrepBanker.",
    "url": "https://prepbanker.com/ibps-po-quiz",
...
const pageFaqs = [
  {
    q: "What is the IBPS PO quiz 2026 on PrepBanker?",
    a: "It is a free practice hub on PrepBanker with sectional quizzes, chapter-wise DPPs and full mock tests built on the current IBPS PO 2026 exam pattern, covering Quant, Reasoning, English, General Awareness and Computer Aptitude, updated to reflect the latest notifications."
  },
  {
    q: "Is the PrepBanker IBPS PO quiz free to attempt?",
  ...
  {
    q: "How many questions are there in IBPS PO prelims?",
    a: "IBPS PO Prelims 2026 has 100 objective questions worth 100 marks, split across English, Quantitative Aptitude and Reasoning, with a total duration of one hour and separate timing enforced for each section."
  },
  {
  ...
  },
  {
    ...
    a: "Yes. Quizzes reflect the updated IBPS PO 2026 Mains pattern of 170 objective questions for 200 marks with greater GA and Digital Awareness weightage, plus descriptive paper."
  },
  {
    q: "How many mock tests should I attempt before IBPS PO prelims?",
    a: "Most aspirants attempt 20 to 30 full-length mocks and 40 to 50 sectional quizzes across the final six to eight weeks, alongside daily chapter-wise DPPs targeted at their weakest sections."
  },
  {
  ...
  },
  {
    ...
    a: "Aim for consistently above 80% accuracy with all questions attempted inside the time limit across at least three separate attempts."
  },
  {
    q: "How is IBPS PO 2026 different from previous years?",
    a: "IBPS PO 2026 (CRP PO/MT-XVI) increased Mains questions from 145 to 170, added a Personality Test stage before the Interview, and shifted extra weightage toward General/Economy/Banking Awareness and Digital Awareness."
  }
];

export default function IbpsPoQuizPage() {
  return (
    <>
      {/* --- SEO JSON-LD Schemas --- */}
        ...
        <QuizHero
          ...
          title={
            <>
              ...
              <span className="text-gold-gradient">IBPS PO</span>
            </>
          }
          description="Attempt free mock tests, sectional drills, and topic-wise quizzes crafted for IBPS PO 2026. Real exam feel. Instant analytics."
        />

        {/* Playable Interactive Mock Quiz flow */}
        <QuizSection initialExamType="IBPS PO" />
        ...
        <div className="container-custom mt-20 space-y-24">
            ...
            <div className="mt-10">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">
                {[
                  ...
                  { title: "IBPS PO Exam Dates", desc: "22-23 August 2026", extra: "Prelims scheduled late August, applications open 1-21 July" },
                  { title: "Mains Exam Format", desc: "Objective + Descriptive", extra: "IBPS: 170 Q (200 Marks) + 2 Descriptive Q (25 Marks)" },
                  { title: "Negative Marking", desc: "0.25 Mark Penalty", extra: "Applicable on incorrect answers; no unattempted penalty" },
                  { title: "Selection Process", desc: "4 Stages (New Pattern)", extra: "Prelims, Mains, Personality Test, and Interview" },
                  { title: "Participating Banks", desc: "11 Public Sector Banks", extra: "Including PNB, BOB, Canara, Union Bank, Indian Bank, etc." }
                ].map((fact, idx) => (
          ...
          <section className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div className="lg:col-span-5 bg-[var(--color-navy-deep)] text-white border border-slate-800 rounded-3xl p-6 sm:p-8 flex flex-col justify-between shadow-md relative overflow-hidden">
              ...
              <div>
                <span className="text-[var(--color-gold-bright)] text-[10px] font-black uppercase tracking-widest block mb-2">IBPS PO Syllabus</span>
                <h2 className="text-xl sm:text-2xl font-black leading-tight mb-4">
                  Master the IBPS National Exam
                </h2>
                <p className="text-slate-350 text-xs sm:text-sm leading-relaxed">
                  Strengthen your concepts and build speed for the IBPS PO national level exam. Mock questions designed to evaluate speed, precision, and accuracy on the latest patterns.
                </p>
              </div>
            ...
            <div className="bg-white border border-slate-100 rounded-3xl p-4 sm:p-8 shadow-sm space-y-6">
                ...
                <table className="min-w-full divide-y divide-slate-100">
                  ...
                  <tbody className="divide-y divide-slate-100 text-xs sm:text-sm text-slate-655 font-medium">
                    {[
                      ...
                      { stage: "Mains (Objective)", format: "Reasoning & Computer, English, Data Interpretation, GA", qs: "170", marks: "200 Marks", time: "190 Minutes (sectional timing)" },
                      { stage: "Mains (Descriptive)", format: "Essay & Letter Writing", qs: "2", marks: "25 Marks", time: "30 Minutes" }
                    ].map((row, idx) => (
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50/30 border border-blue-100 rounded-2xl p-5 flex gap-4">
                ...
                <div className="text-xs sm:text-sm text-slate-700 leading-relaxed">
                  <strong>Pattern Advice:</strong> IBPS PO Mains CRP XVI features an expanded objective question count (170) with higher weight on General Awareness and Digital Awareness. Plan your revision accordingly.
                </div>
              </div>
            </div>
          </section>
                ...
                <table className="min-w-full divide-y divide-slate-100">
                  ...
                  <tbody className="divide-y divide-slate-100 text-xs sm:text-sm text-slate-655 font-medium">
                    {[
                      ...
                      { name: "Data Interpretation (Mains)", time: "30–35 mins", target: "25–28 / 35Q", accuracy: "75%+" },
          ...
          <section className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
              {[
                ...
                { step: "Weeks 5–6", subtitle: "Introduce Full Mocks", desc: "Start attempting full mocks twice weekly, simulating actual IBPS PO exam patterns." },
